    ...
    <>
      <Box sx={{ p: 4 }}>
        ...
        <Grid container>
          ...
          <Button className={classes.btn} onClick={(e) => handleSubmit(e, 'search')}>
            Search
          </Button>
        </Grid>
      </Box>
        ...
        <Grid container>
          ...
          <Grid item xs={6}>
            <TextField
              placeholder="arrival"
              name="arrival"
              value={addState.arrival}
              onChange={handleChange1}
            />
          </Grid>
          <Button className={classes.btn} onClick={(e) => handleSubmit(e, 'add')}>
            Add
          </Button>
        </Grid>
      </Box>
