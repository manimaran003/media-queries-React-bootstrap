    ...
    return(
       ...
       <Box sx={{display:"flex",flexDirection:"row",flexGrow:1,justifyContent:"space-between",alignItems:"center"}}>
           <Box sx={{flexGrow:1,alignItems:"center"}}>
            <img alt="pic" className={classes.img} src="https://previews.123rf.com/images/ikalvi/ikalvi1712/ikalvi171200242/92412982-souriant-cr%C3%A9ation-de-logo-vectoriel-panier-d-achat-shopping-logo-vectoriel-ou-app-.jpg"/>
           </Box>
